...
## Contents
  ...
  - [Dummies](./docs/en/Dummies.md)
     - [`mock()`](./docs/en/mock.md) and [`loadable()`](./docs/en/loadable.md) &mdash; [__See demo__](https://codesandbox.io/s/j2ovpr03z3)
  ...
  - [Inversion](./docs/en/Inversion.md)
     - [`<State>`](./docs/en/State.md) and [`withState()`](./docs/en/State.md#withstate-hoc)
        - [`<Toggle>`](./docs/en/Toggle.md), [`withToggle()`](./docs/en/Toggle.md#withtoggle-hoc), and [`@withToggle`](./docs/en/Toggle.md#withtoggle-decorator) &mdash; [__See demo__](https://codesandbox.io/s/zwkl16vv93)
  ...
  - [Sensors](./docs/en/Sensors.md)
     ...
     - [`<ExitSensor>`](./docs/en/ExitSensor.md) &mdash; [__See demo__](https://codesandbox.io/s/7437x10z71)
     ...
     - [`<SizeSensor>`](./docs/en/SizeSensor.md), [`withSize()`](./docs/en/SizeSensor.md#withsize-hoc), and [`@withSize`](./docs/en/SizeSensor.md#withsize-decorator) &mdash; [__See demo__](https://codesandbox.io/s/0y2qjm210p)
